<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="kpavlak1730EX2H._Default" %>
        ...
        <div class="col-md-6">
            <h2>String Methods</h2> 
                <div class="form-group">
                    ...
                    <asp:TextBox ID="TextBox11" runat="server" OnTextChanged="TextBox11_TextChanged">late</asp:TextBox>
