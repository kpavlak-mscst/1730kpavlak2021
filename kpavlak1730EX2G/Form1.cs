...
namespace kpavlak1730EX2G
{
    public partial class Form1 : Form
    {
        ...
        private void resultIfDefault01TextBox_TextChanged(object sender, EventArgs e)
        {

        }

        private void resultNestedIfElsedefaultTextBox_TextChanged(object sender, EventArgs e)
        {
        ...
        private void resultSwitch02TextBox_TextChanged(object sender, EventArgs e)
        {
        ...
        private void resultNestedIfElse01TextBox_TextChanged(object sender, EventArgs e)
        {
